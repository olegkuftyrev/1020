...
async function loadQuestions() {
  try {
    console.log('Loading P&L questions into database...')
    
    for (const question of plQuestions) {
      await prisma.plQuestion.upsert({
    ...
    console.log(`Loaded ${plQuestions.length} questions`)
  } catch (error) {
